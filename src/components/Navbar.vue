    ...
    <nav :class="[
        ...
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <ul class="hidden md:flex space-x-6 text-blue-600 font-semibold">
                ...
                <li class="relative group">
                    ...
                    <ul
                        ...
                        <li v-for="item in aboutUs" :key="item.to">
                            <router-link :to="item.to" class="block px-4 py-2 hover:bg-blue-100 rounded-lg transition">
                                {{ item.name }}
                            </router-link>
                        </li>
                    </ul>
                ...
                <!-- Contact -->
                <li>
                    <router-link to="/contact" class="hover:text-blue-400 transition">
                        Contact
                    </router-link>
                </li>
            </ul>
        ...
        <div v-if="mobileOpen" class="md:hidden bg-white/80 text-blue-600 px-6 py-4 space-y-4 backdrop-blur-md">
            <div>
                ...
                <ul class="pl-4 space-y-2">
                    <li v-for="item in aboutUs" :key="item.to">
                        <router-link :to="item.to" class="block hover:text-blue-400">
                            {{ item.name }}
                        </router-link>
                    </li>
                </ul>
            ...
            <router-link to="/contact" class="block font-semibold hover:text-blue-400">
                Contact
            </router-link>
        </div>
    </nav>
